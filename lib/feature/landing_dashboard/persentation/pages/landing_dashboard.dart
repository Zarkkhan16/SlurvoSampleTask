...
import 'package:onegolf/core/utils/responsive.dart';
              ...
              children: [
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: Responsive.w(context, 12), vertical: Responsive.h(context, 12)),
                  ...
                  child: GradientBorderContainer(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(Responsive.w(context, 16)),
                      child: Image.asset(
                        AppImages.landingDashboardImage,
                        fit: BoxFit.fill,
                        width: double.infinity,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: GradientBorderContainer(
                      borderRadius: Responsive.w(context, 32),
                      borderWidth: 1,
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius:
                                        BorderRadius.circular(Responsive.w(context, 4)),
                                  ),
                                  child: Text(
                                    "  Free  ",
                                    style: AppTextStyle.roboto(
