...
import 'package:onegolf/feature/combine_test/games/custom_combine_test/presentation/pages/custom_combine_summary_page.dart';
...
class CustomCombineStartPage extends StatelessWidget {
  const CustomCombineStartPage({super.key});
            ...
            SessionViewButton(
              onSessionClick: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CustomCombineSummaryPage(),
                  ),
                );
              },
